...
function MapBootScreen({ label }: { label: string }) {
  return (
    <div className="flex h-full min-h-[420px] w-full flex-col items-center justify-center gap-3 bg-ink font-mono text-xs text-mute">
...
export function DynamicMap(props: MapProps) {
  ...
  if (error) {
    return (
      <div className="flex h-full min-h-[420px] w-full flex-col items-center justify-center gap-2 bg-ink px-6 text-center font-mono text-xs text-mute">
